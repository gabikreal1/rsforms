                        ...
                        child: Column(
                          children: [
                            ...
                            if (value.currentDay != -1) ...[
                              Text(
                                  "${value.currentDay} ${getMonth(value.currentMonth.month)}: ${value.currentDayEarnings}"),
                              Expanded(
                                child: JobList(
                                    joblist: value
                                            .jobsCalendar[DateTime(
                                                value.currentMonth.year, value.currentMonth.month, value.currentDay)]
                                            ?.values
                                            .toList() ??
                                        [],
                                    scrollable: true,
